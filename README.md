...
 - 감정 분석 : 행복, 슬픔 등 8가지 감정 상태를 감지하여 신뢰도 반환​
  > 각 감정의 신뢰도를 정규화 하여 백분율로 변환(JSON 형식)

 < 시점 >​
ㆍ감정 분석: 매번 하나의 음악 재생이 끝날 시

#### [ Jetson Nano & 카메라 인터페이스 ] - 집중도 인식/분석​
< 기능 >​
...
#### [ Jetson Nano & 카메라 인터페이스 ] - 집중도 인식/분석​(알고리즘)
< 적용 알고리즘 >​

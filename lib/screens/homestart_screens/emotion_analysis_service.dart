...
class EmotionAnalysisService {
  ...
  Future<Map<String, dynamic>> runEmotionAnalysis() async {
    final url = Uri.parse('http://192.168.216.219:3000/analyze_emotion');
    try {
  ...
  Future<void> saveEmotions(String emotionResult) async {
    ...
    final url = Uri.parse('http://192.168.216.219:3000/save_emotions');
    try {
  ...
  Future<Map<String, dynamic>> getEmotionTags(String detectedEmotions) async {
    final url = Uri.parse('http://192.168.216.219:3000/get_emotion_tags');
